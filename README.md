...
Status: Currently, learning data structures and algorithms; also learning about the "Big O". Reworking my resume. Found a good resource on what to put in. Decided to not over stress in using GitHub everyday. Mental health is important. Oh no, Heroku why?! Seems like Render putting a strong effort to replace Heroku users. Reading Render's FAQ on transfering from Heroku to Render. Well that could had gone better.
