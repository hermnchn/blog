...
Status: Currently, I'm looking into apprenticeship programs and using their qualification guidelines as a metric on what skills I need to double-down on. It's surprisingly efficient way of knowing what level of knowledge I should have or acquire before applying for jobs. Learning about the "Big O". Been too busy to even sit down and code properly. Reworking my resume. Found a good resource on what to put in. That was annoying as heck. Doing some housekeeping. Decided to not over stress in using GitHub everyday. Mental health is important. Tommorrow is important get some rest.
